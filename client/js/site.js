$(function() {
	...
	var considerTime = 400;		// time window to consider best capture, in ms
	var chillTime = 1000;			// time to chill after committing, in ms
	...
	function commit() {
		...
		$.ajax({
			...
			data: {
				isTestMode: isTestMode,
				score: bestCapture.score,
				dataURL: bestCaptureUrl.replace('img.jpeg', '')
			}
		});
